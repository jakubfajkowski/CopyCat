...
public class AuthorizationServiceImplTest {
    ...
    public void register() throws Exception {
        ...
        assertEquals("User successfully registered", authorizationService.register(new ClientCredentials(login, password)));
        assertEquals("Login is already taken", authorizationService.register(new ClientCredentials(login, password)));
